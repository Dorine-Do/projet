 ...
 */
final class Version20220608093948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, qcm_instance_id INT NOT NULL, student_id INT NOT NULL, level VARCHAR(255) NOT NULL, answers JSON NOT NULL, total_score DOUBLE PRECISION NOT NULL, instructor_comment VARCHAR(500) DEFAULT NULL, student_comment VARCHAR(500) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_136AC113CE2E14FD (qcm_instance_id), INDEX IDX_136AC113CB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(10) NOT NULL, school_year SMALLINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE link_instructor_session DROP FOREIGN KEY FK_FC68D1148C4FC193');
        ...
        $this->addSql('ALTER TABLE link_instructor_session DROP FOREIGN KEY FK_FC68D114613FECDF');
